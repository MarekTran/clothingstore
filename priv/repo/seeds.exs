...
# Insert Tags
Clothingstore.Repo.insert!(%Clothingstore.Tags.Tag{name: "Clothes"})
Clothingstore.Repo.insert!(%Clothingstore.Tags.Tag{name: "Casual"})

# Insert Items
Clothingstore.Repo.insert!(%Clothingstore.Items.Item{
